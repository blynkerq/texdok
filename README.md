...
Приложение прошло как функциональное, так и пользовательское тестирование.  
Вся документация по тестированию находится в папке `testing/`:

- [`test.md`](testing/test.md) — цели и подходы к тестированию

Также был проведён опрос среди 6 одногруппников. Основные выводы:
...
Полный отчёт доступен в файле [`test.md`](testing/test.md).
